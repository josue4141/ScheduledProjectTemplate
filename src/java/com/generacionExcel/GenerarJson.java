...
public class GenerarJson {
    ...
    public void generarJsonCreditoFiscal() throws FileNotFoundException, ParserConfigurationException, SAXException, IOException {
        EnvLoader env = new EnvLoader();
        this.ruta = env.getString("ruta", "outputFilePath");
        String outputFilePath = this.ruta +"CreditoFiscal"+ fechaActualFormato + ".json";
    ...
    public void generarJsonCosumidorFinal() throws FileNotFoundException, ParserConfigurationException, SAXException, IOException {
        EnvLoader env = new EnvLoader();
        this.ruta = env.getString("ruta", "outputFilePath");
        String outputFilePath1 = this.ruta +"CosumidorFinal"+ fechaActualFormato + ".json";
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFilePath1))) {
            for (faturaConsumidorFinal factConsurFinal : daoFaturaConsumidorFinal.getFaturaConsumidorFinal()) {
                ...
                JSONObject arTributos = new JSONObject();
                JSONArray arTributosArray = new JSONArray();
                JSONObject tributos = new JSONObject();
                JSONArray tributosArray = new JSONArray();
                JSONObject unidadMedida = new JSONObject();
                ...
                if (factConsurFinal.getEstado() == 0) {
                    ...
                    tributos.put("tributos", factConsurFinal.getTributos());
                    arTributosArray.put(tributos);
                    ...
                    arTributos.put("codigoTributo", factConsurFinal.getCodigoTributos());
                    ...
                    json.put("contactos", contactoArray);
                    json.put("arTributos", arTributosArray);
                    json.put("unidadMedida", unidadMedidaArray);
                    json.put("tributos", tributosArray);
                    writer.write(json.toString());
                    writer.newLine();
