...
public class FacturaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CargarExcel cargarExcel = new CargarExcel();
        GenerarJson generarExcel = new GenerarJson();
        if (request.getParameter("btnCargar") != null) {
            ...
            cargarExcel.cargarExcel(nombreArchivo);

            response.sendRedirect("index.html");
        } else if (request.getParameter("btnGenerar") != null) {
            generarExcel.generarJsonCosumidorFinal();
            generarExcel.generarJsonCosumidorFinal();
            response.sendRedirect("index.html");
        }
    }
