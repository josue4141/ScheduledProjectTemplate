...
public class creditoFiscal {
    ...
    public double getTotalExportaciones() {
        return totalExportaciones;
    }

    public void setTotalExportaciones(double totalExportaciones) {
        this.totalExportaciones = totalExportaciones;
    }
